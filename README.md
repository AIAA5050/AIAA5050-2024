...
This course is offered at HKUST(GZ) . It is focused on exploring the "ultimate challenge of artificial intelligence" - the study of consciousness. Here, we will delve into the history, current status, and future challenges of machine consciousness research.
...
| Mechanistic Interpretability / Truthfulness                  | [The Geometry of Truth: Emergent Linear Structure in Large Language Model Representations of True/False Datasets](https://arxiv.org/pdf/2310.06824.pdf) | COLM                                                 | 2024             | This paper studies how LLMs internally represent truthfulness on high-quality true/false datasets. It provides evidence for an emergent linear geometry: representations show clear linear separation, probes transfer across datasets, and causal interventions on internal directions can flip the model’s truth judgments. |
| World Representation / State Abstraction                     | [Do LLMs Build World Representations? Probing Through the Lens of State Abstraction](https://proceedings.neurips.cc/paper_files/paper/2024/file/b1b16c4b875eb84d3585cb70d23970ca-Paper-Conference.pdf) | NeurIPS                                              | 2024             | The authors propose a probing framework grounded in state abstraction theory to test whether LLM hidden states encode planning-relevant world representations. Using controlled text-based planning tasks, they show LLMs can form goal-oriented abstractions, and analyze how finetuning and stronger pretraining affect these abstractions. |
| Theory of Mind / Data Generation                             | [Explore Theory of Mind: Program-guided adversarial data generation for theory of mind reasoning](https://proceedings.iclr.cc/paper_files/paper/2025/file/a901d5540789a086ee0881a82211b63d-Paper-Conference.pdf) | ICLR                                                 | 2025             | ExploreToM introduces a program-guided framework to generate diverse, challenging Theory-of-Mind data at scale. It uses A* search over a custom DSL to create complex yet plausible story structures that expose blind spots of existing benchmarks, and reports very low accuracy for strong LLMs on the generated adversarial examples, motivating more robust evaluation and training. |
| Embodied AI / Self-Reflection                                | [Phoenix: A Motion-based Self-Reflection Framework for Fine-grained Robotic Action Correction](https://openaccess.thecvf.com/content/CVPR2025/papers/Xia_Phoenix_A_Motion-based_Self-Reflection_Framework_for_Fine-grained_Robotic_Action_Correction_CVPR_2025_paper.pdf) | CVPR                                                 | 2025             | Phoenix targets fine-grained robotic action correction by bridging high-level semantic reflection and low-level control with motion instructions. It combines MLLM-driven motion refinement with a motion-conditioned diffusion policy for high-frequency action correction, and demonstrates improved robustness and generalization in both simulation and real-world manipulation. |
| Language Agents / Self-Training                              | [Re-ReST: Reflection-Reinforced Self-Training for Language Agents](https://aclanthology.org/2024.emnlp-main.861.pdf) | EMNLP                                                | 2024             | Re-ReST improves self-training for language agents by introducing a reflector that refines low-quality agent-generated trajectories using environment feedback (e.g., tests, rewards). This yields higher-quality supervision without relying on humans or stronger models, and boosts performance across multiple agentic tasks. |
| Mechanistic Interpretability / Truthfulness                  | [The Linear Representation Hypothesis and the Geometry of Large Language Models](https://arxiv.org/pdf/2311.03658) | ICML                                                 | 2024             | In this paper, we provide a formal framework for understanding how large language models (LLMs) linearly represent high-level concepts, introduce a "causal inner product" to define meaningful geometric relationships in their representation space, show how the framework unifies existing empirical practices such as probing and guiding, and empirically validate their approach on LLaMA-2 7B. We show that the causally separable concept becomes orthogonal and enables targeted interventions. |
| Mechanistic Interpretability / Truthfulness                  | [Towards Global-level Mechanistic Interpretability: A Perspective of Modular Circuits of Large Language Models](https://openreview.net/pdf?id=do5vVfKEXZ) | ICML                                                 | 2025             | This paper proposes an approach called ModCirc to achieve global mechanistic interpretability for large language models by discovering and reusing "modular circuits" shared across tasks, thereby improving the generalization of explanations and significantly reducing the cost of human interpretation. |
| Embodied AI / Self-Reflection                                | [Self-Correction Bench: Uncovering and Addressing the Self-Correction Blind Spot in Large Language Models](https://openreview.net/pdf?id=dLz0bnmL2r) | NeurIPS workshop                                     | 2025             | We quantify the "self-correction blind spot" prevalent in large language models, showing that they systematically fail to correct their own generated errors even when they are able to correct the same external errors. We introduce "self-correcting benchmarks" for systematic evaluation and show that a simple "Wait" intervention significantly reduces this blind spot, attributing this phenomenon to the lack of self-correcting sequences in typical training data. |
| Embodied AI / Self-Reflection                                | [Metacognitive Capabilities of LLMs: An Exploration in Mathematical Problem Solving](https://proceedings.neurips.cc/paper_files/paper/2024/file/2318d75a06437eaa257737a5cf3ab83c-Paper-Conference.pdf) | NeurIPS                                              | 2024             | We explore whether large language models possess metacognitive knowledge to solve problems. In this work, we develop a method for LLMS to identify and cluster their self-perceived problem-solving skills, which improves mathematical reasoning accuracy on the MATH dataset by up to 11.6% when these skills are used for skin-aligned contextual learning. |
| Embodied AI / Self-Reflection                                | [Me, Myself, and AI: The Situational Awareness Dataset (SAD) for LLMs](https://proceedings.neurips.cc/paper_files/paper/2024/file/7537726385a4a6f94321e3adf8bd827e-Paper-Datasets_and_Benchmarks_Track.pdf) | NeurIPS                                              | 2024             | The paper introduces SAD, the first large-scale benchmark for evaluating context and self-awareness in large language models.  It includes 13,000+ questions across 16 tasks and 7 categories.  Experiments on 16 mainstream models show major gaps: the best model, Claude 3 Opus, scores only 49.5%, far below the human baseline of 90.7%.  While dialogue fine-tuning and cue words offer limited improvements, context awareness remains weak and only loosely related to general knowledge.  The findings highlight important implications for AI autonomy, planning, and security risks. |
...
| 机制可解释性与真实性探究   | The Geometry of Truth: Emergent Linear Structure in Large Language Model Representations of True/False Datasets | COLM                            | 2024年   | 研究大模型内部是否以“几何结构”编码真假信息，发现真假在表征空间中呈现清晰的线性可分结构，并可跨数据集迁移。进一步通过因果干预（沿特定方向操作内部状态）实现对真假判断的翻转，说明该“真值方向”具有机制层面的可解释性。 |
| 具身智能自我反思与动作纠错 | Phoenix: A Motion-based Self-Reflection Framework for Fine-grained Robotic Action Correction | CVPR                            | 2025年   | 面向机器人“自我纠错”，将高层语义反思落到细粒度动作层：用运动指令作为中间接口，并结合条件扩散策略生成高频动作修正。通过仿真与真实场景验证其鲁棒性与泛化能力，支持交互过程中的持续改进。 |
| 语言代理自训练与自我改进   | Re-ReST: Reflection-Reinforced Self-Training for Language Agents | EMNLP                           | 2024年   | 提出反思增强的自训练框架：引入 reflector 利用环境反馈（如测试/奖励）“修复”低质量轨迹，从而构造更高质量的自训练数据。该方法在多类代理任务上带来稳定提升，强调反思可作为可扩展的能力增长机制。 |
| 机制可解释性与真实性探究   | The Linear Representation Hypothesis and the Geometry of Large Language Models | ICML                            | 2024年   | 本文为理解大型语言模型（LLMs）如何线性表示高级概念提供了一个形式化框架，引入了一个“因果内积”来定义其表示空间中有意义的几何关系，展示了该框架如何统一现有的经验实践，如探测和引导，并在LLaMA-2 7B上经验性地验证了他们的方法，表明因果可分离概念变得正交，并且能够进行有针对性的干预。 |
| 机制可解释性与真实性探究   | Towards Global-level Mechanistic Interpretability: A Perspective of Modular Circuits of Large Language Models | ICML                            | 2025年   | 本文提出了一种名为 ModCirc 的方法，通过发现并复用跨任务共享的“模块化电路”来实现对大语言模型的全局机制可解释性，从而提升解释的泛化性并显著降低人工解释成本。 |
| 具身智能自我反思与动作纠错 | Self-Correction Bench: Uncovering and Addressing the Self-Correction Blind Spot in Large Language Models | NeurIPS workshop                | 2025年   | 量化了大型语言模型中普遍存在的“自我纠正盲点”，表明即使在能够纠正相同的外部错误时，它们也系统性地未能纠正自身生成的错误。该研究引入了“自我纠正基准”进行系统评估，并表明简单的“Wait”（等等）干预能显著减少这一盲点，将这种现象归因于典型训练数据中缺乏自我纠正序列。 |
| 具身智能自我反思与动作纠错 | Metacognitive Capabilities of LLMs: An Exploration in Mathematical Problem Solving | NeurIPS                         | 2024年   | 探索了大型语言模型是否拥有解决问题的元认知知识。本文开发了一种方法，让LLM识别并聚类其自身感知到的解决问题技能，当这些技能用于与技能对齐的上下文学习时，将MATH数据集上的数学推理准确性提高了高达11.6%。 |
...
| ToM（他心理论）评测与对抗式数据生成 | Explore Theory of Mind: Program-guided adversarial data generation for theory of mind reasoning | ICLR        | 2025年   | 提出 ExploreToM：用 DSL + A* 搜索程序化生成更复杂、更多样的他心推理（ToM）叙事样本，以构建更严格的压力测试与训练数据。结果显示强模型在该对抗式样本上会显著失效，提示传统 ToM 基准可能偏乐观。 |
...
| 世界表征与状态抽象探究 | Do LLMs Build World Representations? Probing Through the Lens of State Abstraction | NeurIPS                                              | 2024年   | 从强化学习“状态抽象”的理论视角探测 LLM 是否构建可用于规划的世界状态表征。通过受控的文本规划环境分析不同抽象层级的可恢复性，指出模型更倾向保留“目标导向”的抽象信息，而非完整重建世界动力学。 |
